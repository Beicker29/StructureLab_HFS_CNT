...
- Candidato A (d): `607.000 mm`
- Candidato B (3bf): `684.000 mm`
- Longitud zona protegida requerida: `607.000 mm`
...
- Ambito: `BEAM`
- Verificacion: `lambda_f_beam <= lambda_f_limit; 6.590 ratio <= 6.886 ratio`
...
- Ambito: `BEAM`
- Verificacion: `lambda_w_beam <= lambda_w_limit; 48.839 ratio <= 56.237 ratio`
- Clausula: `Section 2.3.4 (6) + AISC Seismic Provisions`
- Resultado: 🟢 Cumple
...
- Ambito: `COLUMN`
- Verificacion: `lambda_f_col <= lambda_f_limit; 3.589 ratio <= 6.886 ratio`
- Clausula: `Section 2.3.4 (6) + AISC Seismic Provisions`
- Resultado: 🟢 Cumple
...
- Ambito: `COLUMN`
- Verificacion: `lambda_w_col <= lambda_w_limit; 18.009 ratio <= 56.237 ratio`
- Clausula: `Section 2.3.4 (6) + AISC Seismic Provisions`
- Resultado: 🟢 Cumple
...
- Ambito: `END_PLATE`
- Verificacion: `bp <= bbf + 25 mm; bp <= bcf; [min,max] = [177.800 mm, 253.000 mm]`
- Clausula: `Section 6.3 / Table 6.1`
- Resultado: 🟢 Cumple
...
### Chequeo 1.22 - Edge distance at de (`de`)
...
### Chequeo 1.23 - Outside bolt-row distance limits (`pfo - pso`)

- Ambito: `TABLE_6_1`
- Verificacion: `pso (=pfo) >= emin; pfo <= 114 mm; pfo >= 38 mm; [min,max] = [38.100 mm, 114.300 mm]`
- Clausula: `Table 6.1 + AISC 360 Table J3.4`
- Resultado: 🟢 Cumple

### Chequeo 1.24 - Inside bolt-row distance limits (`pfi - psi`)

- Ambito: `TABLE_6_1`
- Verificacion: `pfi >= emin; pfi <= 114 mm; pfi >= 38 mm; psi = pfi + tfb - tcp; psi > 0; [min,max] = [38.100 mm, 114.300 mm]`
- Clausula: `Table 6.1 + AISC 360 Table J3.4`
- Resultado: 🟢 Cumple

### Chequeo 1.25 - Beam flange thickness limits (`tbf`)

- Ambito: `TABLE_6_1`
- Verificacion: `tbf in [tbf_min, tbf_max]; 9.525 mm <= 17.300 mm <= 19.050 mm`
- Clausula: `Table 6.1`
- Resultado: 🟢 Cumple

### Chequeo 1.26 - Beam flange width limits (`bbf`)

- Ambito: `TABLE_6_1`
- Verificacion: `bbf in [bbf_min, bbf_max]; 152.400 mm <= 228.000 mm <= 234.950 mm`
- Clausula: `Table 6.1`
- Resultado: 🟢 Cumple

### Chequeo 1.27 - Connecting beam depth limits (`d`)

- Ambito: `TABLE_6_1`
- Verificacion: `d in [d_min, d_max]; 349.250 mm <= 607.000 mm <= 609.600 mm`
- Clausula: `Table 6.1`
- Resultado: 🟢 Cumple

### Chequeo 1.28 - End-plate thickness limits (`tp`)

- Ambito: `TABLE_6_1`
- Verificacion: `tp in [tp_min, tp_max]; 12.700 mm <= 25.400 mm <= 57.150 mm`
- Clausula: `Table 6.1`
- Resultado: 🟢 Cumple

### Chequeo 1.29 - Horizontal bolt spacing limits (`g`)

- Ambito: `TABLE_6_1`
- Verificacion: `g in [g_min, g_max]; 101.600 mm <= 152.400 mm <= 152.400 mm`
- Clausula: `Table 6.1`
- Resultado: 🟢 Cumple
