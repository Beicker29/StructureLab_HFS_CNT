...
#### Chequeo 1.2.28 - El tipo de soldadura entre placa de extremo y alma de viga debe ser permitido (`weld_ep_web`)
...
#### Chequeo 1.2.29 - Requisitos de soldadura entre ala de viga y placa de extremo (viga derecha) (`tipo_w4_vgder`)
...
#### Chequeo 1.2.30 - Requisitos de soldadura entre ala de viga y placa de extremo (viga izquierda) (`tipo_w4_vgizq`)
...
#### Chequeo 1.2.31 - El tipo de soldadura de platina de continuidad debe declararse y ser permitido (`weld_cp`)
...
#### Chequeo 1.2.32 - Tipo de soldadura de platina de continuidad cuando el espesor es menor o igual a 10 mm (`weld_cp`)
...
#### Chequeo 1.2.33 - El tipo de apriete del perno debe ser una categoria reconocida (`tight_bolt`)
...
#### Chequeo 1.2.34 - Los pernos deben estar pretensionados salvo que una conexion especifica permita lo contrario (`tight_bolt`)
...
#### Chequeo 1.2.35 - La norma de fabricacion de pernos debe ser una designacion ASTM de alta resistencia permitida (`std_bolt`)
...
#### Chequeo 1.2.36 - Distancia de borde en de (right beam) (`de_pe_vgder`)
...
#### Chequeo 1.2.37 - Limites de distancia en fila exterior de pernos (right beam) (`pfo_pe_vgder - pso_pe_vgder`)
...
#### Chequeo 1.2.38 - Limites de distancia en fila interior de pernos (right beam) (`pfi_pe_vgder - psi_pe_vgder`)
...
#### Chequeo 1.2.39 - Limites de espesor del ala de viga (right beam) (`tf_vgder`)
...
#### Chequeo 1.2.40 - Limites de ancho del ala de viga (right beam) (`bf_vgder`)
...
#### Chequeo 1.2.41 - Limites de peralte de la viga conectada (right beam) (`d_vgder`)
...
#### Chequeo 1.2.42 - Limites de espesor de placa de extremo (right beam) (`tpe_vgder`)
...
#### Chequeo 1.2.43 - Limites de separacion horizontal de pernos (right beam) (`g_b_vgder`)
...
#### Chequeo 1.2.44 - Distancia de borde en de (left beam) (`de_pe_vgizq`)
...
#### Chequeo 1.2.45 - Limites de distancia en fila exterior de pernos (left beam) (`pfo_pe_vgizq - pso_pe_vgizq`)
...
#### Chequeo 1.2.46 - Limites de distancia en fila interior de pernos (left beam) (`pfi_pe_vgizq - psi_pe_vgizq`)
...
#### Chequeo 1.2.47 - Limites de espesor del ala de viga (left beam) (`tf_vgizq`)
...
#### Chequeo 1.2.48 - Limites de ancho del ala de viga (left beam) (`bf_vgizq`)
...
#### Chequeo 1.2.49 - Limites de peralte de la viga conectada (left beam) (`d_vgizq`)
...
#### Chequeo 1.2.50 - Limites de espesor de placa de extremo (left beam) (`tpe_vgizq`)
...
#### Chequeo 1.2.51 - Limites de separacion horizontal de pernos (left beam) (`g_b_vgizq`)
...
- Sh adoptado (gobernante): `303.5 mm`
...
- h1_pe_vgizq: `708.35 mm`
- h2_pe_vgizq: `648.35 mm`
- h3_pe_vgizq: `529.65 mm`
- h4_pe_vgizq: `n/a`
- A_b_vgizq: `641.3 mm2`
- Fnt_b_vgizq: `780 MPa`
- Ru_b_p+_vgizq: `585.06 kN`
...
- h1_pe_vgder: `708.35 mm`
- h2_pe_vgder: `648.35 mm`
- h3_pe_vgder: `529.65 mm`
- h4_pe_vgder: `n/a`
- A_b_vgder: `641.3 mm2`
- Fnt_b_vgder: `780 MPa`
- Ru_b_p+_vgder: `585.06 kN`
...
- phi*Rn_pe_m3_vgizq: `1094.83 kN-m`
- DCR_pe_m3_vgizq: `1.45`
- Resultado: `🔴 No cumple`
...
- Fyp_pe_vgizq: `345 MPa`
- Ru_pe_m3_vgizq: `1587.51 kN-m`
- Rn_pe_v1_vgizq: `1346.03 kN`
- phi*Rn_pe_v1_vgizq: `997.67 kN`
- DCR_pe_v1_vgizq: `1.35`
- Resultado: `🔴 No cumple`
...
- phi*Rn_pe_v2_vgizq: `880.05 kN`
- DCR_pe_v2_vgizq: `0.15`
- Resultado: `🟢 Cumple`
...
- phi*Rn_pe_m3_vgder: `1094.83 kN-m`
- DCR_pe_m3_vgder: `1.45`
- Resultado: `🔴 No cumple`
...
- Fyp_pe_vgder: `345 MPa`
- Ru_pe_m3_vgder: `1587.51 kN-m`
- Rn_pe_v1_vgder: `1346.03 kN`
- phi*Rn_pe_v1_vgder: `997.67 kN`
- DCR_pe_v1_vgder: `1.35`
- Resultado: `🔴 No cumple`
...
- phi*Rn_pe_v2_vgder: `880.05 kN`
- DCR_pe_v2_vgder: `0.15`
- Resultado: `🟢 Cumple`
...
- Ru_cf_v2_col_vgizq: `2692.07 kN`
- phi*Rn_cf_v2_col_vgizq: `2893.47 kN`
- DCR_cf_v2_col_vgizq: `0.93`
- Resultado: `🟢 Cumple`
...
- Ru_cf_v2_col_vgder: `2692.07 kN`
- phi*Rn_cf_v2_col_vgder: `2893.47 kN`
- DCR_cf_v2_col_vgder: `0.93`
- Resultado: `🟢 Cumple`
