...
- Ambito: `COLUMN`
- Verificacion: `St_col >= pfo_pe_vgder + de_pe_vgder + 12.5 mm; 240 mm >= 122.5 mm`
...
#### Chequeo 1.2.22 - El tipo de soldadura de platina de continuidad debe declararse y ser permitido (`weld_cp`)
...
#### Chequeo 1.2.23 - Tipo de soldadura de platina de continuidad cuando el espesor es menor o igual a 10 mm (`weld_cp`)
...
#### Chequeo 1.2.24 - El tipo de apriete del perno debe ser una categoria reconocida (`tight_bolt`)
...
#### Chequeo 1.2.25 - Los pernos deben estar pretensionados salvo que una conexion especifica permita lo contrario (`tight_bolt`)
...
#### Chequeo 1.2.26 - La norma de fabricacion de pernos debe ser una designacion ASTM de alta resistencia permitida (`std_bolt`)
...
#### Chequeo 1.2.27 - Separacion minima vertical entre pernos (`pb`)
...
#### Chequeo 1.2.28 - Distancia de borde en de (`de`)
...
#### Chequeo 1.2.29 - Limites de distancia en fila exterior de pernos (`pfo - pso`)
...
#### Chequeo 1.2.30 - Limites de distancia en fila interior de pernos (`pfi - psi`)
...
#### Chequeo 1.2.31 - Limites de espesor del ala de viga (`tbf`)
...
#### Chequeo 1.2.32 - Limites de ancho del ala de viga (`bbf`)
...
#### Chequeo 1.2.33 - Limites de peralte de la viga conectada (`d`)
...
#### Chequeo 1.2.34 - Limites de espesor de placa de extremo (`tp`)
...
#### Chequeo 1.2.35 - Limites de separacion horizontal de pernos (`g`)
