...
- Ambito: `BEAM_IZQ`
- Verificacion: `bp_pe_vgizq >= bf_vgizq + margin (25 mm); 260 mm >= 253 mm`
...
- Ambito: `BEAM_IZQ`
- Verificacion: `g_b_vgizq >= 3db; 135 mm >= 76.2 mm`
- Clausula: `Documento: AISC 358-22 | Seccion: Seccion 6.3 / Tabla 6.1`
- Resultado: 🟢 Cumple
...
- Ambito: `BEAM_IZQ`
- Verificacion: `Sc = St_col - pfo; S = 0.5*sqrt(bcf*g); Sc_vgizq > S => 185.000 mm > 98.932 mm`
...
- Ambito: `BEAM_DER`
- Verificacion: `Sc = St_col - pfo; S = 0.5*sqrt(bcf*g); Sc_vgder > S => 185.000 mm > 98.932 mm`
- Clausula: `Documento: AISC 358-22 | Seccion: Seccion 6.3.1 (criterio de despeje de viga)`
- Resultado: 🟢 Cumple
...
- Ambito: `END_PLATE_STIFFENER_IZQ`
- Verificacion: `h_pest_vgizq = pfo_pe_vgizq + de_pe_vgizq; 110.000 mm = 55.000 mm + 55.000 mm`
- Clausula: `Documento: AISC 358-22 | Seccion: Seccion 6.3`
- Resultado: 🟢 Cumple
...
- Ambito: `END_PLATE_STIFFENER_IZQ`
- Verificacion: `g_b_vgizq >= 2emin + t_pest_vgizq; 135 mm >= 79.4 mm`
- Clausula: `Documento: AISC 358-22 | Seccion: Seccion 6.3 (stiffened) + AISC 360 Tabla J3.4`
- Resultado: 🟢 Cumple
...
#### Chequeo 1.2.37 - El tipo de soldadura de platina de continuidad debe declararse y ser permitido (`weld_cp`)
...
#### Chequeo 1.2.38 - Tipo de soldadura de platina de continuidad cuando el espesor es menor o igual a 10 mm (`weld_cp`)
...
#### Chequeo 1.2.39 - El tipo de apriete del perno debe ser una categoria reconocida (`tight_bolt`)
...
#### Chequeo 1.2.40 - Los pernos deben estar pretensionados salvo que una conexion especifica permita lo contrario (`tight_bolt`)
...
#### Chequeo 1.2.41 - La norma de fabricacion de pernos debe ser una designacion ASTM de alta resistencia permitida (`std_bolt`)
...
#### Chequeo 1.2.42 - Distancia de borde en de (right beam) (`de_pe_vgder`)
...
#### Chequeo 1.2.43 - Limites de distancia en fila exterior de pernos (right beam) (`pfo_pe_vgder - pso_pe_vgder`)

- Ambito: `TABLE_6_1_DER`
- Verificacion: `pso_pe_vgder (=pfo_pe_vgder) >= emin; pfo_pe_vgder <= 140 mm; pfo_pe_vgder >= 44 mm; [min,max] = [44.45 mm, 139.7 mm]`
- Clausula: `Documento: AISC 358-22 | Seccion: Tabla 6.1 + AISC 360 Tabla J3.4`
- Resultado: 🟢 Cumple

#### Chequeo 1.2.44 - Limites de distancia en fila interior de pernos (right beam) (`pfi_pe_vgder - psi_pe_vgder`)

- Ambito: `TABLE_6_1_DER`
- Verificacion: `pfi_pe_vgder >= emin; pfi_pe_vgder <= 140 mm; pfi_pe_vgder >= 44 mm; psi_pe_vgder = pfi_pe_vgder + tf_vgder - tcp_col; psi_pe_vgder > 0; [min,max] = [44.45 mm, 139.7 mm]`
- Clausula: `Documento: AISC 358-22 | Seccion: Tabla 6.1 + AISC 360 Tabla J3.4`
- Resultado: 🟢 Cumple

#### Chequeo 1.2.45 - Limites de espesor del ala de viga (right beam) (`tf_vgder`)
...
#### Chequeo 1.2.46 - Limites de ancho del ala de viga (right beam) (`bf_vgder`)
...
#### Chequeo 1.2.47 - Limites de peralte de la viga conectada (right beam) (`d_vgder`)
...
#### Chequeo 1.2.48 - Limites de espesor de placa de extremo (right beam) (`tpe_vgder`)
...
#### Chequeo 1.2.49 - Limites de separacion horizontal de pernos (right beam) (`g_b_vgder`)
...
#### Chequeo 1.2.50 - Distancia de borde en de (left beam) (`de_pe_vgizq`)

- Ambito: `TABLE_6_1_IZQ`
- Verificacion: `de_pe_vgizq >= emin; 55 mm >= 31.75 mm`
- Clausula: `Documento: AISC 358-22 | Seccion: Tabla 6.1 + AISC 360 Tabla J3.4`
- Resultado: 🟢 Cumple

#### Chequeo 1.2.51 - Limites de distancia en fila exterior de pernos (left beam) (`pfo_pe_vgizq - pso_pe_vgizq`)

- Ambito: `TABLE_6_1_IZQ`
- Verificacion: `pso_pe_vgizq (=pfo_pe_vgizq) >= emin; pfo_pe_vgizq <= 140 mm; pfo_pe_vgizq >= 44 mm; [min,max] = [44.45 mm, 139.7 mm]`
- Clausula: `Documento: AISC 358-22 | Seccion: Tabla 6.1 + AISC 360 Tabla J3.4`
- Resultado: 🟢 Cumple

#### Chequeo 1.2.52 - Limites de distancia en fila interior de pernos (left beam) (`pfi_pe_vgizq - psi_pe_vgizq`)

- Ambito: `TABLE_6_1_IZQ`
- Verificacion: `pfi_pe_vgizq >= emin; pfi_pe_vgizq <= 140 mm; pfi_pe_vgizq >= 44 mm; psi_pe_vgizq = pfi_pe_vgizq + tf_vgizq - tcp_col; psi_pe_vgizq > 0; [min,max] = [44.45 mm, 139.7 mm]`
- Clausula: `Documento: AISC 358-22 | Seccion: Tabla 6.1 + AISC 360 Tabla J3.4`
- Resultado: 🟢 Cumple

#### Chequeo 1.2.53 - Limites de espesor del ala de viga (left beam) (`tf_vgizq`)
...
#### Chequeo 1.2.54 - Limites de ancho del ala de viga (left beam) (`bf_vgizq`)
...
#### Chequeo 1.2.55 - Limites de peralte de la viga conectada (left beam) (`d_vgizq`)
...
#### Chequeo 1.2.56 - Limites de espesor de placa de extremo (left beam) (`tpe_vgizq`)
...
#### Chequeo 1.2.57 - Limites de separacion horizontal de pernos (left beam) (`g_b_vgizq`)

- Ambito: `TABLE_6_1_IZQ`
- Verificacion: `g_b_vgizq in [g_b_vgizq_min, g_b_vgizq_max]; 82.55 mm <= 135 mm <= 152.4 mm`
- Clausula: `Documento: AISC 358-22 | Seccion: Tabla 6.1`
- Resultado: 🟢 Cumple
...
- Vhmax adoptado (gobernante): `426.78 kN`
...
- Mpr_vgizq: `1431.47 kN-m`
- Sh_vgizq: `215.93 mm`
- Mf_vgizq_max: `1542.49 kN-m`
- Mf_vgizq_min: `1523.28 kN-m`
...
- Mpr_vgder: `1165.25 kN-m`
- Sh_vgder: `215.93 mm`
- Mf_vgder_max: `1257.41 kN-m`
- Mf_vgder_min: `1238.2 kN-m`
...
- h1_pe_vgizq: `563.35 mm`
- h2_pe_vgizq: `508.35 mm`
- h3_pe_vgizq: `379.65 mm`
- h4_pe_vgizq: `n/a`
- A_b_vgizq: `506.71 mm2`
- Fnt_b_vgizq: `780 MPa`
- Ru_b_p+_vgizq: `719.64 kN`
...
- phi usado: `0.9`
- Mf_vgder_critico: `1257.41 kN-m`
- h1_pe_vgder: `563.35 mm`
- h2_pe_vgder: `508.35 mm`
- h3_pe_vgder: `379.65 mm`
- h4_pe_vgder: `n/a`
- A_b_vgder: `506.71 mm2`
- Fnt_b_vgder: `780 MPa`
- Ru_b_p+_vgder: `586.64 kN`
...
- Yp_pe_vgizq: `5942.1 mm`
- Tabla Yp aplicada: `AISC 358-22 Tabla 6.3`
- Caso Yp: `Case 1 (de <= s)`
- s_pe_vgizq: `93.67 mm`
- pfi_pe_vgizq_entrada: `55 mm`
- pfi_pe_vgizq_efectivo: `55 mm`
- Ru_pe_m3_vgizq: `1542.49 kN-m`
- phi*Rn_pe_m3_vgizq: `1190.33 kN-m`
- DCR_pe_m3_vgizq: `1.3`
- Resultado: `🔴 No cumple`
...
- Fyp_pe_vgizq: `345 MPa`
- Ru_pe_m3_vgizq: `1542.49 kN-m`
- Rn_pe_v1_vgizq: `1307.86 kN`
- phi*Rn_pe_v1_vgizq: `1025.27 kN`
- DCR_pe_v1_vgizq: `1.28`
- Resultado: `🔴 No cumple`
...
- Rn_pe_v2_vgizq: `1307.86 kN`
- phi*Rn_pe_v2_vgizq: `1026.9 kN`
- DCR_pe_v2_vgizq: `1.27`
- Resultado: `🔴 No cumple`
...
- tf_vgizq: `17.3 mm`
- dh_pe_vgizq: `28.57 mm`
- lc_pe_vgizq: `98.72 mm`
- tpe_vgizq: `25.4 mm`
- Fup_pe_vgizq: `450 MPa`
- Ru_pe_v2_vgizq: `128.53 kN`
- phi*Rn_pe_v2_vgizq: `1015.58 kN`
- DCR_pe_v2_vgizq: `0.13`
- Resultado: `🟢 Cumple`
...
- d_b_vgizq: `25.4 mm`
- Ru_pe_v2_vgizq: `128.53 kN`
- phi*Rn_pe_v2_vgizq: `522.58 kN`
- DCR_pe_v2_vgizq: `0.25`
- Resultado: `🟢 Cumple`
...
- Yp_pe_vgder: `5942.1 mm`
- Tabla Yp aplicada: `AISC 358-22 Tabla 6.3`
- Caso Yp: `Case 1 (de <= s)`
- s_pe_vgder: `93.67 mm`
- pfi_pe_vgder_entrada: `55 mm`
- pfi_pe_vgder_efectivo: `55 mm`
- Ru_pe_m3_vgder: `1257.41 kN-m`
- phi*Rn_pe_m3_vgder: `1190.33 kN-m`
- DCR_pe_m3_vgder: `1.06`
- Resultado: `🔴 No cumple`
...
- Fyp_pe_vgder: `345 MPa`
- Ru_pe_m3_vgder: `1257.41 kN-m`
- Rn_pe_v1_vgder: `1413.77 kN`
- phi*Rn_pe_v1_vgder: `1025.27 kN`
- DCR_pe_v1_vgder: `1.38`
- Resultado: `🔴 No cumple`
...
- Rn_pe_v2_vgder: `1413.77 kN`
- phi*Rn_pe_v2_vgder: `1026.9 kN`
- DCR_pe_v2_vgder: `1.38`
- Resultado: `🔴 No cumple`
...
- tf_col: `n/a`
- Fy_col: `345 MPa`
- Y_c usado: `6817.39 mm`
- Tabla Y_c aplicada: `AISC 358-22 Tabla 6.5`
- Caso Y_c: `n/a`
...
- Ecuacion Y_c: `Y_cs = bcf/2*[h2*(1/s + 1/psi) + h1*(1/s + 1/pso)] + (2/g)*[h2*(s + psi) + h1*(s + pso)]`
...
- Ru_cf_v2_col_vgizq: `2615.71 kN`
- phi*Rn_cf_v2_col_vgizq: `1712.22 kN`
- DCR_cf_v2_col_vgizq: `1.53`
- Resultado: `🔴 No cumple`
...
- Ru_cw_v2_col_vgizq: `2615.71 kN`
- phi*Rn_cw_v2_col_vgizq: `1987.85 kN`
- DCR_cw_v2_col_vgizq: `1.32`
- Resultado: `🔴 No cumple`
...
- Ru_cf_v2_col_vgder: `2827.54 kN`
- phi*Rn_cf_v2_col_vgder: `1712.22 kN`
- DCR_cf_v2_col_vgder: `1.65`
- Resultado: `🔴 No cumple`
...
- Ecuacion 2w_w4_vgder: `2w = t_w4.1`
- Ecuacion Rn aplicada: `eq_6_7_20`
- Ru_cw_v2_col_vgder: `2827.54 kN`
- phi*Rn_cw_v2_col_vgder: `1987.85 kN`
- DCR_cw_v2_col_vgder: `1.42`
- Resultado: `🔴 No cumple`
