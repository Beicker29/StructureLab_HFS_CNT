...
class AISC358EndPlateStrategy:
    strategy_id: str = "aisc358.end_plate"
    connection_family: str = "moment_prequalified"
    connection_types: tuple[str, ...] = ("bueep_4e", "bseep_4es", "bseep_8es")
